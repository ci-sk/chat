...
const loginFun = async () => {
  try {
    ...
    //     alert('Login failed');
    //   }
    login(username.value, password.value, true, (res) => {
    ...
    >
      <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
        ...
        <div class="mt-12 flex flex-col items-center">
          <h1 class="text-2xl xl:text-3xl font-extrabold">登录</h1>
          <div class="w-full flex-1 mt-8">
            <div class="flex flex-col items-center">
              ...
              >
                ...
                <span class="ml-4"> 使用GitHub登录 </span>
              </button>
            </div>
            ...
            <div
              v-if="errorMessage"
              class="mb-4 text-sm text-red-600 bg-red-100 p-3 rounded-lg text-center"
            >
              {{ errorMessage }}
            </div>
            ...
            <div class="mx-auto max-w-xs">
              ...
              >
                ...
                <span class="ml-3">{{ isLoading ? "登录中..." : "登录" }}</span>
              </button>
